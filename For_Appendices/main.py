...
swarm = Swarm(seeker_pop=set.settings['seeker_population'], seeker_speed_number=set.settings['seeker_speed_number'], seeker_com_number=set.settings['seeker_com_number'], seeker_repulsion_number=set.settings['seeker_repulsion_number'], seeker_battery_number=set.settings['seeker_battery_number'], seeker_gps_accuracy=set.settings['seeker_gps_accuracy'], seeker_sensor_accuracy=set.settings['seeker_sensor_accuracy'], seeker_memory_duration=set.settings['seeker_memory_duration'], explorer_pop=set.settings['explorer_population'], explorer_speed_number=set.settings['explorer_speed_number'], explorer_com_number=set.settings['explorer_com_number'], explorer_repulsion_number=set.settings['explorer_repulsion_number'], explorer_battery_number=set.settings['explorer_battery_number'], explorer_gps_accuracy=set.settings['explorer_gps_accuracy'], explorer_sensor_accuracy=set.settings['explorer_sensor_accuracy'], explorer_memory_duration=set.settings['explorer_memory_duration'], iso_pop=set.settings['isocontour_population'], iso_speed_number=set.settings['iso_speed_number'], iso_com_number=set.settings['iso_com_number'], iso_repulsion_number=set.settings['iso_seeking_repulsion_number'], iso_seeking_repulsion_number=set.settings['iso_seeking_repulsion_number'], iso_spreading_repulsion_number=set.settings['iso_spreading_repulsion_number'], iso_battery_number=set.settings['iso_battery_number'], iso_gps_accuracy=set.settings['iso_gps_accuracy'], iso_sensor_accuracy=set.settings['iso_sensor_accuracy'], iso_memory_duration=set.settings['iso_memory_duration'], iso_goal=set.settings['isocontour_goal'], iso_thresh=set.settings['isocontour_threshold'], timestep=set.settings['timestep'], map_size=set.settings['map_size'], external_force_magnitude=set.settings['external_force_magnitude'], inertia=set.settings['inertia'], decay=set.settings['decay'], scalar_duration=set.settings['scalar_duration'], relative_strength=set.settings['relative_strength'], fidelity=set.settings['fidelity'], target_setting=set.settings['target_setting'], target_speed_number=set.settings['target_speed_number'])
